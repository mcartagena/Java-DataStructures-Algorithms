...
public class PostOrderBinaryTree{
	...
	public static void postOrderBinaryTree(Node<Character> root){
		if(root == null){
			return;
		}
				
		postOrderBinaryTree(root.getLeftChild());
		postOrderBinaryTree(root.getRightChild());
